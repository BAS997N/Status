...
if (firebaseState.isActive) {
  try {
    ...
    console.error("Failed to initialize Firebase with configured credentials, falling back to simulation mode:", error);
    firebaseState.isActive = false; // Fallback to simulation
  }
} else {
